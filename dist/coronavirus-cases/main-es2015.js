...
let ApiService = class ApiService {
    ...
    addCases(cases) {
        return this.http.post(apiUrl, cases, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((c) => console.log(`added cases w/ id=${c._id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addCases')));
    }
